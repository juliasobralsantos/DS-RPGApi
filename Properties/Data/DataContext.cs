...
namespace RPGApi.Data
{
    public class DataContext : DbContext //: = herança; a classe herdará os dados da outra
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
            new Arma() { Id = 1, Nome = "Adaga", Dano =25, PersonagemId = 1},
            new Arma() { Id = 2, Nome = "Espada", Dano =43, PersonagemId = 2},
            new Arma() { Id = 3, Nome = "Ácido", Dano =103, PersonagemId = 3},
            new Arma() { Id = 4, Nome = "Bastão", Dano =2, PersonagemId = 4},
            new Arma() { Id = 5, Nome = "Pistola", Dano =89, PersonagemId = 5},
            new Arma() { Id = 6, Nome = "Granada", Dano =250, PersonagemId = 6},
            new Arma() { Id = 7, Nome = "Arco e flecha", Dano =124, PersonagemId = 7}
            );
            ...
            //Inicio da criação de usuário padrão
